    ...
    <div class="card-body">
        ...
        <form action="{{ route('dashboard.barista.events.update', $event->evento_id) }}" method="POST" class="row g-3" enctype="multipart/form-data">
            ...
            <div class="col-12">
                ...
                <textarea id="eventDescriptionEdit" name="descricao" rows="3" class="form-control">{{ old('descricao',$event->descricao) }}</textarea>
            </div>
            <div class="col-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formNovoTipoEvento" class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="form-label">Descrição</label>
                        <textarea id="eventTypeDescriptionEdit" name="descricao" class="form-control" rows="3"></textarea>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initMap();
    var desc = document.getElementById('eventDescriptionEdit');
    if (desc && window.ClassicEditor) {
        ClassicEditor.create(desc).catch(function(){});
    }
    var descType = document.getElementById('eventTypeDescriptionEdit');
