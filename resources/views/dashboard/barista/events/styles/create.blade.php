...
@section('title','Novo Estilo de Atração')
@section('content')
<div class="d-flex align-items-center justify-content-between pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h3 m-0">Novo Estilo de Atração</h1>
    <a href="{{ route('dashboard.barista.events.styles') }}" class="btn btn-outline-secondary">Voltar</a>
    </div>
<div class="card"><div class="card-body">
    <form method="POST" action="{{ route('dashboard.barista.events.styles.store') }}" class="row g-3">
        @csrf
        <div class="col-md-6">
