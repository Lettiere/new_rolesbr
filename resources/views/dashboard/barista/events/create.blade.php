...
<div class="pt-3 pb-2 mb-3 border-bottom d-flex align-items-center justify-content-between">
    <h1 class="h3 m-0">Novo Evento</h1>
...
<div class="card">
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('dashboard.barista.events.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
            @csrf
            <div class="col-md-6">
                ...
                <select name="bares_id" class="form-select" required>
                    ...
                    @foreach($establishments as $e)
                        <option value="{{ $e->bares_id }}">{{ $e->nome }}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-md-6">
                ...
                <div class="input-group">
                    <select name="tipo_evento_id" id="tipo_evento_id" class="form-select">
                        ...
                        @foreach($types as $t)
                            <option value="{{ $t->tipo_evento_id }}">{{ $t->nome }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="idade_minima" class="form-control" min="0">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="time" name="hora_abertura_portas" class="form-control">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                ...
                <input type="text" name="local_customizado" class="form-control" placeholder="Se diferente do endereço do bar">
            </div>
            <div class="col-md-8">
                <label class="form-label">Endereço do evento</label>
                <input type="text" name="endereco_evento" class="form-control" placeholder="Rua, número, bairro, cidade">
            </div>
            <div class="col-md-2">
                <label class="form-label">Latitude</label>
                <input type="text" name="latitude_evento" class="form-control">
            </div>
            <div class="col-md-2">
                <label class="form-label">Longitude</label>
                <input type="text" name="longitude_evento" class="form-control">
            </div>
            ...
            <div class="col-12">
                ...
                <div class="row g-2">
                    <div class="col-md-3"><input type="file" name="logo_img_1" class="form-control" accept="image/*"></div>
                    <div class="col-md-3"><input type="file" name="logo_img_2" class="form-control" accept="image/*"></div>
                    <div class="col-md-3"><input type="file" name="logo_img_3" class="form-control" accept="image/*"></div>
                    <div class="col-md-3"><input type="file" name="logo_img_4" class="form-control" accept="image/*"></div>
                </div>
